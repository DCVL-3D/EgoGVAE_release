...
def local_to_global(local_mat, body_model):
    # local_mat: (B, T, J, 3, 3)
    B, T, J, _, _ = local_mat.shape
    local_pose = local_mat.reshape(B*T, J, 3, 3)
    global_pose = local_pose.clone()
    kintree = body_model.kintree_table[0].long()
    ...
    return global_pose.reshape(B, T, J, 3, 3)

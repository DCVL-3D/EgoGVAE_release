...
from egoallo_original.src.egoallo import fncsmpl
from rich_dataset import RichTestData


def main(
    smplh_npz_path: Path = Path("/home/dev2/Drive_C/KHW/_egotext/head2motion/dataset/smplh/neutral/model.npz"),
    data_npz_dir: Path = Path("/home/dev2/Drive_C/KHW/_egotext/head2motion/dataset/rich/WHAM/preprocessed/neutral"),
    output_file: Path = Path("/home/dev2/Drive_C/KHW/_egotext/head2motion/dataset/rich/WHAM/rich_dataset_wham.hdf5"),
    output_list_file: Path = Path("/home/dev2/Drive_C/KHW/_egotext/head2motion/dataset/rich/WHAM/rich_dataset_wham.txt"),
    ...
    def worker(device_idx: int) -> None:
        ...
        while True:
            ...
            test_data = RichTestData.load_from_npz(

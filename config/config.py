...
class DataConfig:
    HDF5_PATH = Path("/home/dev2/Drive_C/KHW/_egotext/head2motion/dataset/amass/amass_dataset.hdf5")
    FILE_LIST_PATH = Path("/home/dev2/Drive_C/KHW/_egotext/head2motion/dataset/amass/amass_dataset_files.txt")
    SUBSEQ_LEN = 128
...
class TrainConfig:
    ...
    CHECKPOINT_DIR = './outputs/checkpoints_paper_jjh_v3'
    ...
    LAMBDA_SKATING = 5.0E-3
    
    KL_ANNEAL_END_STEP = 759 * 30
...
class EvalConfig:
    ...
    CHECKPOINT_PATH = "./outputs/checkpoints_paper_jjh_v3/epoch_300.pth"

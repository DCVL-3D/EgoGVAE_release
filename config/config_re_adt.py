...
class DataConfig:
    HDF5_PATH = Path("/home/dev2/Drive_C/KHW/_egotext/_head2motion/dataset/ADT_FINAL_reflect.hdf5")
    FILE_LIST_PATH = Path("/home/dev2/Drive_C/KHW/_egotext/_head2motion/dataset/ADT_FINAL_reflect.txt")

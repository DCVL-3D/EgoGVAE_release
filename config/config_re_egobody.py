...
class DataConfig:
    HDF5_PATH = Path("/home/dev2/Drive_C/KHW/_egotext/_head2motion/dataset/EGOBODY_EGOALLO.hdf5")
    FILE_LIST_PATH = Path("/home/dev2/Drive_C/KHW/_egotext/_head2motion/dataset/EGOBODY_EGOALLO.txt")
    SUBSEQ_LEN = 128
